public class BreadthFirstPaths {
    ...
    // MODIFICAÇÃO: Fila para guardar a ordem exata de visitação
    private Queue<Integer> ordemVisita;
    ...
    public BreadthFirstPaths(Graph graph, int s) {
        ...
        // MODIFICAÇÃO: Inicializando a fila
        ordemVisita = new Queue<Integer>();
    ...
    private void bfs(Graph graph, int s) {
        ...
        // MODIFICAÇÃO: Registrando a origem como o primeiro vértice visitado
        ordemVisita.enqueue(s);
        ...
        while (!queue.isEmpty()) {
            ...
            for (int w : graph.adj(v)) {
                if (!marked[w]) {
                    ...
                    // MODIFICAÇÃO: Registrando o vértice assim que ele é descoberto na busca em largura
                    ordemVisita.enqueue(w);
                }
            }
        }
    }
    ...
    private void bfs(Graph graph, Iterable<Integer> sources) {
        ...
        for (int s : sources) {
            ...
            // MODIFICAÇÃO: Registrando a origem
            ordemVisita.enqueue(s);
        }
        while (!queue.isEmpty()) {
            int v = queue.dequeue();
            for (int w : graph.adj(v)) {
                if (!marked[w]) {
                    ...
                    // MODIFICAÇÃO: Registrando o vértice
                    ordemVisita.enqueue(w);
                }
            }
        }
    ...
    // MODIFICAÇÃO: Método para retornar a ordem de visitação para a classe Main
    public Iterable<Integer> getOrdemVisita() {
        return ordemVisita;
    }
